      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          <Paragraph type="secondary">
            Track and master competitive programming problems with a spaced repetition approach.
          </Paragraph>
        </div>
        ...
        <div>
          ...
          >
            Your handle will be used to filter out already solved problems from contests.
          </Paragraph>
        </div>
      </Card>
    </div>
